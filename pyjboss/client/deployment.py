...
class DeploymentPy(NamespacedClient):
    ...
    def get_undertow_information(self, deployment, sub_deployment=None):
        ...
        Parameters
        ----------
        :param deployment: The name of package file that was deployed, the name must be with the extesion
            .war, .ear or .jar.
        :param sub_deployment: This parameter is optional and only be used if you have a package .ear and it has
            packages inside it.
        """
        if not sub_deployment:
